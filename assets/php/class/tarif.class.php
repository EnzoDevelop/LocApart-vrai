...
class tarif
{
    ...
    public function insert($id,$dd, $df, $p, $idb)
    {
        $data = ["id_tarif" => NULL,
            ":dd_tarif" => $dd,
        ":df_tarif" => $df,
        ...
        $sql = "INSERT INTO tarif (id_tarif,dd_tarif, df_tarif, prix_loc, id_bien)
         VALUES (:id_tarif, :dd_tarif, :df_tarif, :prix_loc, :id_bien)";
        $stmt = $this->con->prepare($sql);
        $stmt->execute($data);
    }

    public function update($id, $dd, $df, $p, $idb)
    {
        $data = [
